...
function ApproximateEnvTruncation(
        ctm_alg, envspace::ElementarySpace, trscheme::TruncationScheme;
        check_fidelity::Bool = false, maxiter::Int = 50, tol::Float64 = 1.0e-10, verbosity::Int = 0
    )
    return ApproximateEnvTruncation(ctm_alg, envspace, trscheme, check_fidelity, maxiter, tol, verbosity)
end
